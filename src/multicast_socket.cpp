...
bool BroadcastingMulticastSocketListener::del_listener(
        MulticastSocket::ListenerKey key) {
    return listeners_.erase(key) > 0;
}

void BroadcastingMulticastSocketListener::on_datagram(
...
void LoggingMulticastSocketListener::on_datagram(
        const mx3_gen::Datagram & datagram) {
